...
from jiant.tasks.lib.crowdenvent import (
    CrowdEnventEmotionClassification,
    CrowdEnventSuddennessClassification,
    CrowdEnventFamiliarityClassification,
    CrowdEnventPredictEventClassification,
    CrowdEnventPleasantnessClassification,
    CrowdEnventUnpleasantnessClassification,
    CrowdEnventGoalRelevanceClassification,
    CrowdEnventChanceResponsbltClassification,
    CrowdEnventSelfResponsbltClassification,
    CrowdEnventOtherResponsbltClassification,
    CrowdEnventPredictConseqClassification,
    CrowdEnventGoalSupportClassification,
    CrowdEnventUrgencyClassification,
    CrowdEnventSelfControlClassification,
    CrowdEnventOtherControlClassification,
    CrowdEnventChanceControlClassification,
    CrowdEnventAcceptConseqClassification,
    CrowdEnventStandardsClassification,
    CrowdEnventSocialNormsClassification,
    CrowdEnventAttentionClassification,
    CrowdEnventNotConsiderClassification,
    CrowdEnventEffortClassification,
    CrowdEnventSuddennessRegression,
    CrowdEnventFamiliarityRegression,
    CrowdEnventPredictEventRegression,
    CrowdEnventPleasantnessRegression,
    CrowdEnventUnpleasantnessRegression,
    CrowdEnventGoalRelevanceRegression,
    CrowdEnventChanceResponsbltRegression,
    CrowdEnventSelfResponsbltRegression,
    CrowdEnventOtherResponsbltRegression,
    CrowdEnventPredictConseqRegression,
    CrowdEnventGoalSupportRegression,
    CrowdEnventUrgencyRegression,
    CrowdEnventSelfControlRegression,
    CrowdEnventOtherControlRegression,
    CrowdEnventChanceControlRegression,
    CrowdEnventAcceptConseqRegression,
    CrowdEnventStandardsRegression,
    CrowdEnventSocialNormsRegression,
    CrowdEnventAttentionRegression,
    CrowdEnventNotConsiderRegression,
    CrowdEnventEffortRegression,
)
...
TASK_DICT = {
    "crowdenvent_emo_cls": CrowdEnventEmotionClassification,
    "crowdenvent_suddenness_cls": CrowdEnventSuddennessClassification,
    "crowdenvent_familiarity_cls": CrowdEnventFamiliarityClassification,
    "crowdenvent_predict_event_cls": CrowdEnventPredictEventClassification,
    "crowdenvent_pleasantness_cls": CrowdEnventPleasantnessClassification,
    "crowdenvent_unpleasantness_cls": CrowdEnventUnpleasantnessClassification,
    "crowdenvent_goal_relevance_cls": CrowdEnventGoalRelevanceClassification,
    "crowdenvent_chance_responsblt_cls": CrowdEnventChanceResponsbltClassification,
    "crowdenvent_self_responsblt_cls": CrowdEnventSelfResponsbltClassification,
    "crowdenvent_other_responsblt_cls": CrowdEnventOtherResponsbltClassification,
    "crowdenvent_predict_conseq_cls": CrowdEnventPredictConseqClassification,
    "crowdenvent_goal_support_cls": CrowdEnventGoalSupportClassification,
    "crowdenvent_urgency_cls": CrowdEnventUrgencyClassification,
    "crowdenvent_self_control_cls": CrowdEnventSelfControlClassification,
    "crowdenvent_other_control_cls": CrowdEnventOtherControlClassification,
    "crowdenvent_chance_control_cls": CrowdEnventChanceControlClassification,
    "crowdenvent_accept_conseq_cls": CrowdEnventAcceptConseqClassification,
    "crowdenvent_standards_cls": CrowdEnventStandardsClassification,
    "crowdenvent_social_norms_cls": CrowdEnventSocialNormsClassification,
    "crowdenvent_attention_cls": CrowdEnventAttentionClassification,
    "crowdenvent_not_consider_cls": CrowdEnventNotConsiderClassification,
    "crowdenvent_effort_cls": CrowdEnventEffortClassification,
    "crowdenvent_suddenness_reg": CrowdEnventSuddennessRegression,
    "crowdenvent_familiarity_reg": CrowdEnventFamiliarityRegression,
    "crowdenvent_predict_event_reg": CrowdEnventPredictEventRegression,
    "crowdenvent_pleasantness_reg": CrowdEnventPleasantnessRegression,
    "crowdenvent_unpleasantness_reg": CrowdEnventUnpleasantnessRegression,
    "crowdenvent_goal_relevance_reg": CrowdEnventGoalRelevanceRegression,
    "crowdenvent_chance_responsblt_reg": CrowdEnventChanceResponsbltRegression,
    "crowdenvent_self_responsblt_reg": CrowdEnventSelfResponsbltRegression,
    "crowdenvent_other_responsblt_reg": CrowdEnventOtherResponsbltRegression,
    "crowdenvent_predict_conseq_reg": CrowdEnventPredictConseqRegression,
    "crowdenvent_goal_support_reg": CrowdEnventGoalSupportRegression,
    "crowdenvent_urgency_reg": CrowdEnventUrgencyRegression,
    "crowdenvent_self_control_reg": CrowdEnventSelfControlRegression,
    "crowdenvent_other_control_reg": CrowdEnventOtherControlRegression,
    "crowdenvent_chance_control_reg": CrowdEnventChanceControlRegression,
    "crowdenvent_accept_conseq_reg": CrowdEnventAcceptConseqRegression,
    "crowdenvent_standards_reg": CrowdEnventStandardsRegression,
    "crowdenvent_social_norms_reg": CrowdEnventSocialNormsRegression,
    "crowdenvent_attention_reg": CrowdEnventAttentionRegression,
    "crowdenvent_not_consider_reg": CrowdEnventNotConsiderRegression,
    "crowdenvent_effort_reg": CrowdEnventEffortRegression,
